...
export default function ForgotPasswordPage() {
    ...
    const handleResetPassword = async (e: React.FormEvent) => {
        ...
        if (res.ok) {
            await showAlert({ title: "Password Reset!", message: "Your password has been successfully updated. You can now log in with your new password.", variant: "success", buttonText: "Go to Login" });
            ...
            <div className="bg-white p-10 md:p-12 rounded-[3rem] shadow-2xl w-full max-w-md border border-white text-center">
                ...
                {step === 1 ? (
                    ...
                    <form onSubmit={handleResetPassword} className="space-y-4">
                        <input type="email" name="email" autoComplete="username" value={email} readOnly style={{ display: 'none' }} aria-hidden="true" />
                        <input
                            type="text"
                            name="reset-code"
